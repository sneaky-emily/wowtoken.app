import { Chart, Legend, LinearScale, LineController, LineElement, PointElement, TimeSeriesScale, Title, Tooltip } from "chart.js";
import "chartjs-adapter-dayjs-4";

Chart.register(LineElement, PointElement, LineController, LinearScale, TimeSeriesScale, Legend, Title, Tooltip);
...
export default class TokenChart {
  ...
  async createChart(region, time, yLevel, data) {
    ...
    if (this._lateUpdate) {
      if (this._lastDatum.getPrice() !== lateUpdateData.getPrice() && this._lastDatum.getTime() < lateUpdateData.getTime()) {
